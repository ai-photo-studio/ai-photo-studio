...
| `gpu-research-service` | Cloud Run service | us-east4 | == DELETED 2026-07-25 == Research project, never in production | N/A |
| `ai-photo-studio-bg-remover-gpu-us-east4` | Cloud Run service | us-east4 | == DELETED 2026-07-25 == Secondary region, never used | N/A |
