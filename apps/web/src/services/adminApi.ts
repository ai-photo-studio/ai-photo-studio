...
import type { AdminDashboardResponse, AdminPaymentRecord, AdminRestorationDetailResponse, AdminStatsResponse, AdminSubscriptionRecord, AdminWalletRecord, RestorationOrderSummary } from "../lib/portal-types";
...
export const adminApi = {
  ...
  restorationDetail: (id: string) => request<AdminRestorationDetailResponse>(`/api/admin/restorations/${id}`),
