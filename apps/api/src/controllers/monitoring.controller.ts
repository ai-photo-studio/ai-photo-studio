...
import { getEventLoopMetrics } from "../services/event-loop-monitor.service";
import { getSocketStats } from "../middleware/connection-lifecycle.middleware";
...
export class MonitoringController {
  ...
  connections = async (_req: Request, res: Response): Promise<void> => {
    res.json({
      success: true,
      data: {
