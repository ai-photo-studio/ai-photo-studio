...
const EXCLUDED_FILES = new Set<string>([
  ...
  "apps/api/src/services/bank-alfalah-request-hash.ts",
  "apps/api/src/services/bank-alfalah-request-hash.test.ts",
  "apps/api/src/services/bank-alfalah-response-parser.ts",
  "apps/api/src/services/bank-alfalah-response-parser.test.ts",
