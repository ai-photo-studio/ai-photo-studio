  ...
  policies: [
    {
      ...
      qualityTarget: 40,
      description: "Preview tier - Replicate primary, OpenAI fallback",
    },
    {
      tier: "basic",
      primaryProvider: "replicate",
      ...
      qualityTarget: 50,
      description: "Basic tier - Replicate primary, OpenAI fallback",
    },
    {
      tier: "premium",
      primaryProvider: "replicate",
      ...
      qualityTarget: 85,
      description: "Premium tier - Replicate primary, OpenAI fallback",
    },
    {
      tier: "print",
      primaryProvider: "replicate",
      ...
      qualityTarget: 90,
      description: "Print tier - Replicate primary, OpenAI fallback",
    },
    {
      tier: "archive",
      primaryProvider: "replicate",
      ...
      costCapPerImage: 0.010,
      qualityTarget: 50,
      description: "Archive tier - Replicate primary, OpenAI fallback",
    },
  ],
  defaultTier: "basic",
  shadowMode: false,
