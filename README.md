...
- Release-candidate production metadata is ThanNow-specific and contains no placeholder analytics identifiers or unrelated ecommerce-domain metadata. Customer-facing unavailable product/package states use plain availability language; internal blocker codes remain server-side/configuration data.
